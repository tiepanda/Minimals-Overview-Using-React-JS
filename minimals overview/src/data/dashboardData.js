...
export const sidebarMenuItems = [
  ...
  {
    items: [
      { icon: dashboardIcon, label: "App", path: "/app" },
      // { icon: ecommerceIcon, label: "Ecommerce", path: "/ecommerce" },
      // { icon: analyticsIcon, label: "Analytics", path: "/analytics" },
      // { icon: bankingIcon, label: "Banking", path: "/banking" },
      { icon: bookingIcon, label: "Booking", path: "/booking" },
      // { icon: fileIcon, label: "File", path: "/file" },
      { icon: courseIcon, label: "Course", path: "/course" },
    ],
  },
